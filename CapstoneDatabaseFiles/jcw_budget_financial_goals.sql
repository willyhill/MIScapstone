...
CREATE TABLE `financial_goals` (
  ...
  `goal_type` enum('Savings','Investment','Debt Reduction') NOT NULL,
  ...
  PRIMARY KEY (`goal_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `financial_goals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
-- Dump completed on 2025-03-25 16:37:07
